...
class CustomerControllerTest {
    ...
    public void getAllCustomersTest() throws Exception {
        this.mockMvc.perform(get("/customers"))
                ...
                .andExpect(content().json("[{\"name\":\"Test Testsson\",\"ssn\":\"900110\", \"id\":1}," +
                        "{\"name\":\"Test Testberg\",\"ssn\":\"800615\", \"id\":2}," +
                        "{\"name\":\"Test Testman\",\"ssn\":\"701013\", \"id\":3}]"));
    }
    ...
    void addCustomerByPost() throws Exception {
        this.mockMvc.perform(post("/customers/add")
                        ...
                        .content("{\"name\":\"Test Tester\",\"ssn\":\"500515\",\"id\":5}"))
                .andExpect(status().isOk())
                .andExpect(content()
